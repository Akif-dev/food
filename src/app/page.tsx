      ...
      <main>
        ...
        >
          ...
          <div className="relative max-w-3xl mx-auto text-center px-4">
            ...
            >
              Order via <span className="gradient-text-amber italic">WhatsApp</span>
            </h2>

            <p className={`text-lg mb-8 ${isDark ? 'text-white/50' : 'text-gray-500'}`}>
              Place your order directly through WhatsApp for quick and convenient delivery. Simply
              click the button below to get started!
            </p>

            <div className="flex justify-center">
              <a
                href={`https://wa.me/923216638470?text=Hi! I'd like to place an order from Ice n Spice`}
                target="_blank"
                rel="noopener noreferrer"
                className="whatsapp-btn px-12 py-4 rounded-2xl font-bold text-white text-base flex items-center justify-center gap-3 transition-all duration-300 hover:scale-105 hover:shadow-2xl"
                style={{
