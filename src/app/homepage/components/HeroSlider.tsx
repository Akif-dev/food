        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <Link
                href="#menu-section"
                className="px-8 py-4 rounded-2xl text-base font-bold text-white bg-[rgba(255,255,255,0.09)] backdrop-blur-[20px] border border-[rgba(255,255,255,0.2)] hover:bg-white/10 transition-all duration-300 hover:scale-105 cursor-pointer"
              >
                {slide.ctaSecondary}
              </Link>
            </div>
